...
int main() {
    ...
    //dp[sum][sm_already] - # of ways to choose digits so far
    // such that the sum of digits modulo d is 'sum' and
    //'sm_already' says whether we already has chosen some digit smaller
    // than in K
