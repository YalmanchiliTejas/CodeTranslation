...
inline const bool gridin(const int i,const int j,const int H,const int W){return i>=0&&i<H&&j>=0&&j<W;}
...
out(dp[K.size()-1][0][0]+dp[K.size()-1][1][0]-1);
