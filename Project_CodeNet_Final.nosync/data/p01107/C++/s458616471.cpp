...
void solve(){
    ...
    while (true) {
        ...
        goals.push_back(mp(0, 0));
        goals.push_back(mp(n - 1, 0));
        goals.push_back(mp(0, m - 1));
        goals.push_back(mp(n - 1, m - 1));
        int ok = 1;
        REP(i,n){
            REP(q, m) {
                int visited[50][50] = {};
                visited[i][q] = 1;
                visited[goals[0].first][goals[0].second] = 1;
                ...
                REP(q, 4) {
                    if (visited[goals[q].first][goals[q].second] == 0) {
                        ok = 0;
                    }
                }
            }
