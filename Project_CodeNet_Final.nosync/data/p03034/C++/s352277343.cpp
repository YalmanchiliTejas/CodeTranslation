...
#define srep(i, s, x) for (ll i = s; i < x; i++)
#define rrep(i, x) for (ll i = x - 1; i >= 0; i--)
#define rrep1(i, x) for (ll i = x; i > 0; i--)
#define rsrep(i, s, x) for (ll i = x - 1; i >= s; i--)
...
template <typename A, typename... Lest> string to_string(A *v, ll n, Lest... L) {
    bool first = true;
    string ret = "{";
    rep(i, n) {
        auto x = v[i];
