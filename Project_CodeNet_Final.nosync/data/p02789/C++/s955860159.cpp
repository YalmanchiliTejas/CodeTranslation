...
#define fora_init(...) over8(__VA_ARGS__, fora_init_8, a, fora_init_6, a, fora_init_4, a, fora_init_2)(__VA_ARGS__)
...
#define forr_init(...) over8(__VA_ARGS__, forr_init_8, a, forr_init_6, a, forr_init_4, a, forr_init_2)(__VA_ARGS__)
...
#define fora(...) over8(__VA_ARGS__, fora_8, a, fora_6, a, fora_4, a, fora_2)(__VA_ARGS__)
#define forr(...) over8(__VA_ARGS__, forr_8, a, forr_6, a, forr_4, a, forr_2)(__VA_ARGS__)
...
#ifdef _DEBUG
#define deb(...)  cerr<< over10(__VA_ARGS__,deb10,deb9,deb8,deb7,deb6,deb5,deb4,deb3,deb2,deb1)(__VA_ARGS__) <<endl
#else
#define deb(...) ;
#endif
