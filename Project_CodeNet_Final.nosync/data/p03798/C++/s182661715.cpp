...
int N;
string Calc(string s, char first, char second) {
    string retVal;
    retVal += first;
    retVal += second;
    ...
    //cout << retVal << ":" << current << ":" << idealLast << endl;

    if (current == retVal[0] && retVal[index-1] == idealLast) {
        return retVal;
    }
...
int main() {
    ...
    string ss = Calc(s, 'S', 'S');
    if (ss != "") {
        cout << ss << endl;
        return 0;
    }

    string sw = Calc(s, 'S', 'W');
    if (sw != "") {
        cout << sw << endl;
        return 0;
    }

    string ww = Calc(s, 'W', 'W');
    if (ww != "") {
        cout << ww << endl;
        return 0;
    }

    string ws = Calc(s, 'W', 'S');
    if (ws != "") {
        cout << ws << endl;
        return 0;
    }
