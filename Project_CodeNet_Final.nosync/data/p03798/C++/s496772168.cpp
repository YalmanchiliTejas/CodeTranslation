...
int main() {
	...
	rep(i,0,4) {
		...
		data[1] = i%2;
		rep(i,2,N) {
			if ((s[i-1] == 'o') && (data[i-1] == 0)) {
				data[i] = data[i-2];
			} else if ((s[i-1] == 'o') && (data[i-1] == 1)) {
				data[i] = 1-data[i-2];
			} else if ((s[i-1] == 'x') && (data[i-1] == 0)) {
				data[i] = 1-data[i-2];
			} else if ((s[i-1] == 'x') && (data[i-1] == 1)) {
				data[i] = data[i-2];
			}
		}
		if (((s[0] == 'o') && (data[0] == 0) && (data[1] == data[N-1]))
		|| ((s[0] == 'x') && (data[0] == 0) && (data[1] != data[N-1]))
		|| ((s[0] == 'o') && (data[0] == 1) && (data[1] != data[N-1]))
		|| ((s[0] == 'x') && (data[0] == 1) && (data[1] == data[N-1]))) {
			if (((s[N-1] == 'o') && (data[N-1] == 0) && (data[0] == data[N-2]))
			|| ((s[N-1] == 'x') && (data[N-1] == 0) && (data[0] != data[N-2]))
			|| ((s[N-1] == 'o') && (data[N-1] == 1) && (data[0] != data[N-2]))
			|| ((s[N-1] == 'x') && (data[N-1] == 1) && (data[0] == data[N-2]))) {
				rep(i,0,N) {
					if (data[i] == 0) {
						cout << 'S';
					} else {
