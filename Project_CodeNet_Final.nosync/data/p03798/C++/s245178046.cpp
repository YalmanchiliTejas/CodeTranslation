...
void solve(){
    ...
    for (int i = 0; i < 4; ++i)
    {
        ...
        for (int i = 0; i < N; ++i)
        {
            if ((ans.substr(i, 2) == "SS" && S[i] == 'o')
              ||(ans.substr(i, 2) == "SW" && S[i] == 'x')
              ||(ans.substr(i, 2) == "WS" && S[i] == 'x')
              ||(ans.substr(i, 2) == "WW" && S[i] == 'o'))
            {
                ans += "S";
            }else{
                ans += "W";
        ...
        if (ans[ans.size() - 2] == ans[0] && ans[ans.size() - 1] == ans[1])
        {
