...
signed main() {
	...
	fk(4){
		...
		for(int i=0 ; i<n-2 ; ++i){
			if (a[i + 1] == 0 && s[i + 1] == 'o') a[i + 2] = a[i];
			if (a[i + 1] == 0 && s[i + 1] == 'x') a[i + 2] = 1 - a[i];
			if (a[i + 1] == 1 && s[i + 1] == 'o') a[i + 2] = 1 - a[i];
			if (a[i + 1] == 1 && s[i + 1] == 'x') a[i + 2] = a[i];
			ret[i + 2] = a[i + 2];
		}

		if(
			(
				a[n - 1] == 0 && s[n - 1] == 'o' && a[0] == a[n - 2] ||
				a[n - 1] == 0 && s[n - 1] == 'x' && a[0] == 1 - a[n - 2] ||
				a[n - 1] == 1 && s[n - 1] == 'o' && a[0] == 1 - a[n - 2] ||
				a[n - 1] == 1 && s[n - 1] == 'x' && a[0] == a[n - 2]
			) && (
				a[0] == 0 && s[0] == 'o' && a[1] == a[n - 1] ||
				a[0] == 0 && s[0] == 'x' && a[1] == 1 - a[n - 1] ||
				a[0] == 1 && s[0] == 'o' && a[1] == 1 - a[n - 1] ||
				a[0] == 1 && s[0] == 'x' && a[1] == a[n - 1]
			)
		){
			fi(n){
				if (ret[i] == 0) ret[i] = 'S';
