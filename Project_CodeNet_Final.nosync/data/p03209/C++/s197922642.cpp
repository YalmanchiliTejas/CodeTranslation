...
#define vendl std::endl
	...
	const Point DP4[] = {Point(DX4[0], DY4[0]), Point(DX4[1], DY4[1]), Point(DX4[2], DY4[2]), Point(DX4[3], DY4[3])};
	const Point DP8[] = {Point(DX8[0], DY8[0]), Point(DX8[1], DY8[1]), Point(DX8[2], DY8[2]), Point(DX8[3], DY8[3]), Point(DX8[4], DY8[4]), Point(DX8[5], DY8[5]), Point(DX8[6], DY8[6]), Point(DX8[7], DY8[7])};
	...
	public:
		...
		Grid(int w, int h) :
			W(w), H(h) {
			mGrid.resize(H, vector<char>(W, '\0'));
		}
	...
	template<typename A>void input(A&a){cin>>a;cin.ignore();}
	template<typename A,typename B>void input(A&a,B&b){cin>>a>>b;cin.ignore();}
	template<typename A,typename B,typename C>void input(A&a,B&b,C&c){cin>>a>>b>>c;cin.ignore();}
	template<typename A,typename B,typename C,typename D>void input(A&a,B&b,C&c,D&d){cin>>a>>b>>c>>d;cin.ignore();}
	template<typename A,typename B,typename C,typename D,typename E>void input(A&a,B&b,C&c,D&d,E&e){cin>>a>>b>>c>>d>>e;cin.ignore();}
	template<typename A,typename B,typename C,typename D,typename E,typename F>void input(A&a,B&b,C&c,D&d,E&e,F&f){cin>>a>>b>>c>>d>>e>>f;cin.ignore();}
	template<typename A,typename B,typename C,typename D,typename E,typename F,typename G>void input(A&a,B&b,C&c,D&d,E&e,F&f,G&g){cin>>a>>b>>c>>d>>e>>f>>g;cin.ignore();}

	template<typename A>
	void inputR(vector<A>& a, int size) {
		resize(a, size);
	...
	void inputR(vector<A>& a, vector<B>& b, int size) {
	...
	void inputR(vector<A>& a, vector<B>& b, vector<C>& c, int size) {
	...
	void inputR(vector<A>& a, vector<B>& b, vector<C>& c, vector<D>& d, int size) {
	...
	void inputR(vector<A>& a, vector<B>& b, vector<C>& c, vector<D>& d, vector<E>& e, int size) {
	...
	template<typename A>
	void inputR(vector<vector<A>>& a, int h, int wa) {
		resize(a, h, wa);
		for (int i = 0; i < h; ++i) {
			for (int j = 0; j < wa; ++j) {
				cin >> a[i][j];
	...
	template<typename A,typename B>
	void inputR(vector<vector<A>>& a, vector<vector<B>>& b, int h, int wa, int wb) {
	...
	template<typename A,typename B,typename C>
	void inputR(vector<vector<A>>& a, vector<vector<B>>& b, vector<vector<C>>& c, int h, int wa, int wb, int wc) {
