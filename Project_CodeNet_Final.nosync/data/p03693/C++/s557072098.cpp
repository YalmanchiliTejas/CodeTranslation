...
// using Lint = bmp::cpp_int;
// using Real = bmp::number<bmp::cpp_dec_float<1024>>;
...
#define fi first
#define se second
#define index f89dsjj4
#define next ytjbmy8k
#define prev j4qzjkys
...
int main() {
  ll r;
  ignore_ret(scanf("%lld",&r));
  ll g;
  ignore_ret(scanf("%lld",&g));
  ll b;
