...
#define VERNIY st();int ver=0,niy=0
...
template<class Ver>
inline void prd(Ver a){cout<<a<<endl;};
template<class Ver>
inline void prdd(Ver a,Ver b){cout<<a<<" "<<b<<endl;};
template<class Ver>
inline void prtd(Ver a, Ver b, Ver c){cout<<a<<" "<<b<<" "<<c<<endl;};
