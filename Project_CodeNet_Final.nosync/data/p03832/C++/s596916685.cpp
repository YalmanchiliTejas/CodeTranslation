...
void solve(){
	i64 mod=1000000007;
	init_mod_comb(1001,1001,mod);
	init_fact(1001*1001,mod);

	unordered_map<i64,i64> inv_table;
	auto inv=[&](i64 x){
		if(inv_table.find(x)!=inv_table.end()) return inv_table[x];
		return inv_table[x]=mod_inverse(x,mod);
	};
