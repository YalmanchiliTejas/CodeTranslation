...
public:
    ...
    //比較
    constexpr bool operator<(const modlong &r) { return this->val < r.val; }
    constexpr bool operator>(const modlong &r) { return this->val > r.val; }
    constexpr bool operator==(const modlong &r) { return this->val == r.val; }
    constexpr bool operator!=(const modlong &r) { return !(*this == r); }
    constexpr bool operator<=(const modlong &r) { return !(*this > r); }
    constexpr bool operator>=(const modlong &r) { return !(*this < r); }
    ...
    // 四則演算&代入
    constexpr void operator+=(const modlong &r) { *this = *this + r; }
    constexpr void operator-=(const modlong &r) { *this = *this - r; }
    constexpr void operator*=(const modlong &r) { *this = *this * r; }
    constexpr void operator/=(const modlong &r) { *this = *this / r; }
