...
void _main()
{
    ...
    rep (i, n) {
        ...
        debug_printf("0: dp0=%lld dp1=%lld dp2=%lld\n",
                     dp[i+1][0][0], dp[i+1][0][1], dp[i+1][0][2]);
        debug_printf("2: dp0=%lld dp1=%lld dp2=%lld\n",
                     dp[i+1][2][0], dp[i+1][2][1], dp[i+1][2][2]);
        debug_printf("4: dp0=%lld dp1=%lld dp2=%lld\n",
                     dp[i+1][4][0], dp[i+1][4][1], dp[i+1][4][2]);
    }
