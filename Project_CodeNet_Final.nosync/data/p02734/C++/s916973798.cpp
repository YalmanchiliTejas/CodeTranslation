...
// MAX= 5* 10^6 程度ならそれほど気にしなくてよい(300ms程)
...
// ll const mod=1e9+7;
ll const dekai = POW(10, 12);  // POW(2,63)-1.素数.
ll dx[4] = {-1, 0, 1, 0};
ll dy[4] = {0, -1, 0, 1};
...
// // 多倍長テンプレ 俺のpcのg++では使えない atcoderでは使える
// /* ---------------------- ここから ---------------------- */
...
int main() {
	...
	// dp[i][j]=i個の中から選んでjにする場合の数(l,r)の取り方も考慮
