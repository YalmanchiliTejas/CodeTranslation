...
int _main()
{
        ...
        rep (i, n) {
                if (i & 1LL) evenlist.pb(alist[i]);
                else oddlist.pb(alist[i]);
        }

        if (n & 1LL) {
                rrep (i, oddlist.size()) cout << oddlist[i] << " ";
                rep (i, evenlist.size()-1) cout << evenlist[i] << " ";
                cout << evenlist[evenlist.size()-1];
        }
        else {
                rrep (i, evenlist.size()) cout << evenlist[i] << " ";
                rep (i, oddlist.size()-1) cout << oddlist[i] << " ";
                cout << oddlist[oddlist.size()-1];
        }
