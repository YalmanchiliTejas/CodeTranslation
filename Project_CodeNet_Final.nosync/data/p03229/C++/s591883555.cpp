...
int n,a[100004],ta,tta;
deque<int> ans,now,ans2;
signed main() {
    ...
    ta=0;
    {
        ...
        while(now.size()){
            if (i) {
                if(i&1){
                    ans2.push_front(now.front());
                    now.pop_front();
                    if (now.size()) {
                        ans2.push_back(now.front());
                        now.pop_front();
                    }
                }else{
                    ans2.push_front(now.back());
                    now.pop_back();
                    if (now.size()) {
                        ans2.push_back(now.back());
                        now.pop_back();
                    }
                }
            }else{
