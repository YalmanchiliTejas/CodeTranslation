...
int main()
{
	...
	{
		lint up1, up, down1, down;
		up = n / 2 + n % 2;
		up1 = 1 + n % 2;
		down = n / 2;
		down1 = 1 - n % 2;

		ansdown = 2*acc(a.begin() + down, a.end()) - acc(a.begin() + down, a.begin() + down + up1)
			-(2*acc(a.begin(), a.begin() + down) - acc(a.begin() + down - down1, a.begin() + down));
	}
...

	{
		...
		ansup = 2*acc(a.begin() + down, a.end()) - acc(a.begin() + down, a.begin() + down + up1)
			- (2 * acc(a.begin(), a.begin() + down) - acc(a.begin() + down - down1, a.begin() + down));
	}

	cout << mmax(ansdown, ansup) << endl;
