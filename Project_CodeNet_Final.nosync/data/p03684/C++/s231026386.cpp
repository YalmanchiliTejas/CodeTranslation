...
int main()
{
    ...
    for (int i = 0; i + 1 < N; i++)
    {
        int a = x[i].first.first, b = x[i].first.second, na = x[i + 1].first.first, nb = x[i + 1].first.second;
    ...
    for (int i = 0; i + 1 < N; i++)
    {
        int a = y[i].first.first, b = y[i].first.second, na = y[i + 1].first.first, nb = y[i + 1].first.second;
