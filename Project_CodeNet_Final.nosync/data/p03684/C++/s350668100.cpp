...
void in(){}; template <class T, class...TS> void in(T &&x, TS &&...xs) { cin >> x; in(move(xs)...); };
template <class T> void out(T &&x) { cout << x << "\n"; }; template <class T, class...TS> void out(T &&x, TS &&...xs) { cout << x << " "; out(move(xs)...); }
