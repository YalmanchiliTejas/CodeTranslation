...
public:
    ...
    bool dfs(int y, int x) {
        ...
        if(yx.first < 0 && yx.second < 0) return false;
        return dfs(yx.first, yx.second);
    }
	...
	void solve(std::istream& in, std::ostream& out) {
        ...
        visited.assign(h, vi(w, 0));
        if(dfs(0, 0)) out << "Possible" << enl;
        else out << "Impossible" << enl;
	}
};
