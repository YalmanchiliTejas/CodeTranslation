...
/*int dp[1001];
    ...
    REP(i,1,n){
        if(v[i] == 0){
            ar[0][i][0]=ar[0][i-1][0];
            REP(j,1,n){
                ar[j][i][0] = ar[j-1][i][0]+ar[j][i-1][0];
                ar[j][i][0] %= M;
            }
            REP(j,0,n){
                ar[j][i][1] = ar[j-1][i][1];
            ...
            ar[0][i][0]=ar[0][i-1][0];
            REP(j,1,n){
                ar[j][i][0] = ar[j-1][i][0]+ar[j][i-1][0]+ar[j][i-1][1];
                ar[j][i][0] %= M;
            }
            REP(j,0,n){
                ar[j][i][1] = ar[j-1][i][1];
