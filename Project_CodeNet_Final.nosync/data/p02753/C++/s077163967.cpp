...
int main(){
    cin >> buf_answer;
    if ((((buf_answer.asString().find(Var("A").asString()) != string::npos) && (!(buf_answer.asString().find(Var("B").asString()) != string::npos))) || ((buf_answer.asString().find(Var("B").asString()) != string::npos) && (!(buf_answer.asString().find(Var("A").asString()) != string::npos))))){
        cout << Var("No") << endl;
    } else {
        cout << Var("Yes") << endl;
    }
