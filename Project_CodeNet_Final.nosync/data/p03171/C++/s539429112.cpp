...
// fun(l,r) stores values of Max(X'-Y') or Max(Y'-X') depending on 
// who is going to pick first in that interval.
// Hence a[l] - fun(l+1,r) = a[r] - fun(l,r-1) = aX - (Y' - X') = (x'+aX) - (Y') = X - Y
