...
ll fun(int st,int l,int r,ll a[])
{
	if(l==r)
	{if(st==0)
	return dp[l][r][st]=a[l];
	return dp[l][r][st]=-a[l];
    }
	if(dp[l][r][st]!=-1)
	return dp[l][r][st];
	if(st==0)
	return dp[l][r][st]=max(a[l]+fun(1-st,l+1,r,a),a[r]+fun(1-st,l,r-1,a));
	return dp[l][r][st]=min(-a[l]+fun(1-st,l+1,r,a),-a[r]+fun(1-st,l,r-1,a));
}
