...
public:
    ...
    T &value() {
//        static string mes = "optional has no value";assert2(!is_null, mes);
        return v;}
    const T &value() const {
//        static string mes = "optional has no value";assert2(!is_null, mes);
        return v;}
...
//optional<T>
//+-/*
template<class T, class O> optional<O> operator+(const T &tem, const optional<O> &opt) {    return optional<O>(opt.value() + tem);}
template<class T, class O> optional<O> operator-(const T &tem, const optional<O> &opt) {    return optional<O>(opt.value() - tem);}
template<class T, class O> optional<O> operator*(const T &tem, const optional<O> &opt) {    return optional<O>(opt.value() * tem);}
template<class T, class O> optional<O> operator/(const T &tem, const optional<O> &opt) {    return optional<O>(opt.value() / tem);}

template<class T, class O> optional<O> operator+(const optional<O> &opt, const T &tem) {    return optional<O>(opt.value() + tem);}
template<class T, class O> optional<O> operator-(const optional<O> &opt, const T &tem) {    return optional<O>(opt.value() - tem);}
