    ...
    */
    ...
    REP(tc,1,ntc+1)
    {
        ...
        if(n%2==0)
        {
            ...
            REP(i,0,n+1)
            {
                if((i&1LL)==0) ans=max(ans,dp[i][0]+dp[n][1]-dp[i][1]);
            }
            cout<<ans;
        }
        else
        {
            ...
            REP(i,0,n)
            {
                if((i&1LL)==1) dp[i+1][0]=dp[i][0];
                else dp[i+1][0]=dp[i][0]+a[i];
                if((i&1LL)==1) dp[i+1][1]=dp[i][1]+a[i];
                else dp[i+1][1]=dp[i][1];
                if((i&1LL)==1) dp[i+1][2]=dp[i][2];
                else dp[i+1][2]=dp[i][2]+a[i];
