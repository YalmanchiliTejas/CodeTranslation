...
template<class T, class U> bool chma(T &a, const U &b) noexcept{    if (a < b) {        a = b;        return true;    }    return false;}
...
nullopt_t& operator +(const nullopt_t &, const nullopt_t&) noexcept{return nullopt;}
...
template<class ANY> nullopt_t operator+(const nullopt_t&, const ANY &) noexcept{return nullopt;}
template<class ANY> nullopt_t operator-(const nullopt_t&, const ANY &) {return nullopt;}
template<class ANY> nullopt_t operator*(const nullopt_t&, const ANY &) {return nullopt;}
template<class ANY> nullopt_t operator/(const nullopt_t&, const ANY &) {return nullopt;}
template<class ANY> nullopt_t operator+(const ANY &, const nullopt_t &)noexcept {return nullopt;}
template<class ANY> nullopt_t operator-(const ANY &, const nullopt_t &) {return nullopt;}
template<class ANY> nullopt_t operator*(const ANY &, const nullopt_t &) {return nullopt;}
template<class ANY> nullopt_t operator/(const ANY &, const nullopt_t &) {return nullopt;}

template<class ANY> void operator+=(nullopt_t &, const ANY &) noexcept{}
template<class ANY> void operator-=(nullopt_t &, const ANY &) {}
template<class ANY> void operator*=(nullopt_t &, const ANY &) {}
template<class ANY> void operator/=(nullopt_t &, const ANY &) {}
template<class ANY> void operator+=(ANY &, const nullopt_t &) noexcept{}
...
//optional<T>
//+-/*
template<class T, class O> optional<O> operator+(const T &tem, const optional<O> &opt) noexcept{    if (opt.has_value()) { return optional<O>(tem + opt.value()); }    return optional<O>();}
...
template<class T, class O> optional<O> operator+(const optional<O> &opt, const T &tem) noexcept{ return tem + opt; }
...
//(a+=null) != (a=a+null)
// a            null
template<class T, class O> void operator+=(T &tem, const optional<O> &opt) noexcept{ if (opt.has_value()) { tem += opt.value(); }}
template<class T, class O> void operator-=(T &tem, const optional<O> &opt) { if (opt.has_value()) { tem -= opt.value(); }}
template<class T, class O> void operator*=(T &tem, const optional<O> &opt) { if (opt.has_value()) { tem *= opt.value(); }}
template<class T, class O> void operator/=(T &tem, const optional<O> &opt) { if (opt.has_value()) { tem /= opt.value(); }}

template<class T, class O> void operator+=(optional<O> &opt, const T &tem) noexcept{ if (opt.has_value()) { opt.value() += tem; }}
template<class T, class O> void operator-=(optional<O> &opt, const T &tem) { if (opt.has_value()) { opt.value() -= tem; }}
template<class T, class O> void operator*=(optional<O> &opt, const T &tem) { if (opt.has_value()) { opt.value() *= tem; }}
template<class T, class O> void operator/=(optional<O> &opt, const T &tem) { if (opt.has_value()) { opt.value() /= tem; }}

template<class O> void operator+(optional<O> &opl, const optional<O> &opr) noexcept{ if (opr.has_value()) { return opl + opr.value(); }}
template<class O> void operator-(optional<O> &opl, const optional<O> &opr) { if (opr.has_value()) { return opl - opr.value(); }}
template<class O> void operator*(optional<O> &opl, const optional<O> &opr) { if (opr.has_value()) { return opl * opr.value(); }}
template<class O> void operator/(optional<O> &opl, const optional<O> &opr) { if (opr.has_value()) { return opl / opr.value(); }}

template<class Ol, class Or> void operator+=(optional<Ol> &opl, const optional<Or> &opr) noexcept{ if (opr.has_value()) { return opl += opr.value(); }}
...
//null , optional, T
bool chma(nullopt_t &, const nullopt_t &) noexcept{ return false; }
template<class T> bool chma(T &opt, const nullopt_t &) noexcept{ return false; }
template<class T> bool chma(nullopt_t &, const T &opt) noexcept{ return false; }
template<class T> bool chma(optional<T> &olv, const optional<T> &orv) noexcept{ if (orv.has_value()) { return chma(olv, orv.value()); } else return false; }
template<class T, class U> bool chma(optional<T> &opt, const U &rhs) noexcept{ if (opt.has_value()) { return chma(opt.value(), rhs); } else return false; }
template<class T, class U> bool chma(T &lhs, const optional<U> &opt) noexcept{ if (opt.has_value()) { return chma(lhs, opt.value()); } else return false; }
