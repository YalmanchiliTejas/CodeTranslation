...
//切り上げ
long double ceil_n(long double dIn, long long nLen) {
    long double dOut;
    dOut = dIn * pow(10.0, nLen);
    dOut = (long double) (long long) (dOut + 0.9);
    return dOut * pow(10.0, -nLen);
}

//切り捨て
long double floor_n(long double dIn, long long nLen) {
    long double dOut;
    dOut = dIn * pow(10.0, nLen);
    dOut = (long double) (long long) (dOut);
    return dOut * pow(10.0, -nLen);
}

//四捨五入
long double round_n(long double dIn, long long nLen) {
    long double dOut;
    dOut = dIn * pow(10.0, nLen);
    dOut = (long double) (long long) (dOut + 0.5);
    return dOut * pow(10.0, -nLen);
}
...
#define MULD(arr) accumulate((arr).begin(), (arr).end(), 1., multiplies<long double>())
