...
static PyObject* segtree_op(PyObject* a, PyObject* b){
    return PyObject_CallFunctionObjArgs(segtree_op_py, a, b, NULL);
}
static PyObject* segtree_e_py;
static PyObject* segtree_e(){
    return segtree_e_py;
}
static PyObject* segtree_f_py;
static bool segtree_f(PyObject* x){
    PyObject* pyfunc_res = PyObject_CallFunctionObjArgs(segtree_f_py, x, NULL);
...
struct SegTree{
    PyObject_HEAD
    segtree<PyObject*, segtree_op, segtree_e>* seg;
    PyObject* op;
    PyObject* e;
    int n;
};
...
static int SegTree_init(SegTree* self, PyObject* args){
    ...
    if(PyLong_Check(arg)){
        ...
        self->seg = new segtree<PyObject*, segtree_op, segtree_e>(n);
        self->n = n;
    }else{
        ...
        Py_DECREF(iterator);
        if (PyErr_Occurred()) return -1;
        self->seg = new segtree<PyObject*, segtree_op, segtree_e>(vec);
        self->n = (int)vec.size();
    }
    return 0;
}
static PyObject* SegTree_set(SegTree* self, PyObject* args){
    ...
    Py_INCREF(x);  // 参照カウント増えるけど減らない…後で修正する
    set_op_e(self);
    self->seg->set((int)p, x);
    Py_RETURN_NONE;
}
static PyObject* SegTree_get(SegTree* self, PyObject* args){
    ...
    PyObject* res = self->seg->get((int)p);
...
static PyObject* SegTree_prod(SegTree* self, PyObject* args){
    ...
    PARSE_ARGS("ll", &l, &r);
    set_op_e(self);
    PyObject* res = self->seg->prod((int)l, (int)r);
    return Py_BuildValue("O", res);
}
static PyObject* SegTree_all_prod(SegTree* self, PyObject* args){
    PyObject* res = self->seg->all_prod();
    return Py_BuildValue("O", res);
}
