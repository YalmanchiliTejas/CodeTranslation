...
int main(void) {
    ...
    if(K==1){
        ans += (ll)combi(N - 1, 1) * pow(9, 1);
        ans += (ll)(S[pos] - '0' - 1);
        ans += 1;
    }else if(K==2){
        ans += (ll)combi(N - 1, 2) * pow(9, 2);
        dump(ans);
        ans += (ll)(S[pos] - '0' - 1) * combi(N - 1, 1) * pow(9, 1);
        dump(ans);
        ...
        ans += (ll)combi(N - 1 - pos, 1) * pow(9, 1);
        dump(ans);
        ans += (ll)(S[pos] - '0' - 1);
        dump(ans);
        ans += 1;
    }else if(K==3){
        ans += (ll)combi(N - 1, 3) * pow(9, 3);
        dump(ans);
        ans += (ll)(S[pos] - '0' - 1) * combi(N - 1, 2) * pow(9, 2);
        dump(ans);
        ...
        ans += (ll)combi(N - 1 - pos, 2) * pow(9, 2);
        dump(ans);
        ans += (ll)(S[pos] - '0' - 1) * combi(N - 1 - pos, 1) * pow(9, 1);
        dump(ans);
