...
using bdou = boost::multiprecision::cpp_dec_float_100;
...
//vector to tuple
template<class A, class B, class C> auto vtot(vector<A> &a, vector<B> &b, vector<C> &c) {    assert(sz(a) == sz(b) && sz(b) == sz(c));    vector<tuple<A, B, C>> res;    rep(i, sz(a))res.eb(a[i], b[i], c[i]);    return res;}
template<class A, class B, class C, class D> auto vtot(vector<A> &a, vector<B> &b, vector<C> &c, vector<D> &d) {    assert(sz(a) == sz(b) && sz(b) == sz(c) && sz(c) == sz(d));    vector<tuple<A, B, C, D>> res;    rep(i, sz(a))res.eb(a[i], b[i], c[i], d[i]);    return res;}

template<class A, class B, class C> auto ttov(const vector<tuple<A, B, C>> &v) {    tuple<vector<A>, vector<B>, vector<C>> res;    for (int i = 0; i < v.size(); i++) {        get<0>(res).push_back(get<0>(v[i]));        get<1>(res).push_back(get<1>(v[i]));        get<2>(res).push_back(get<2>(v[i]));    }    return res;}
template<class A, class B, class C, class D> auto ttov(const vector<tuple<A, B, C, D>> &v) {    tuple<vector<A>, vector<B>, vector<C>, vector<D>> res;    for (int i = 0; i < v.size(); i++) {        get<0>(res).push_back(get<0>(v[i]));        get<1>(res).push_back(get<1>(v[i]));        get<2>(res).push_back(get<2>(v[i]));        get<3>(res).push_back(get<3>(v[i]));    }    return res;}
/*@formatter:off*/
...
template<class A, class B, class C> void sortt(vector<A> &a, vector<B> &b, vector<C> &c) {    auto d = vtot(a, b, c);    sort(d);    tie(a, b, c) = ttov(d);}
template<class A, class B, class C> void rsortt(vector<A> &a, vector<B> &b, vector<C> &c) {    auto d = vtot(a, b, c);    rsort(d);    tie(a, b, c) = ttov(d);}
...
template<class U> void sort(vector<U> &a, pcomparator type) {    if (type == fisi) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<1>(l) < get<1>(r); });    else if (type == fisd) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<1>(l) > get<1>(r); }); else if (type == fdsi) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<1>(l) < get<1>(r); }); else if (type == fdsd) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<1>(l) > get<1>(r); }); else if (type == sifi) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<0>(l) < get<0>(r); }); else if (type == sifd) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<0>(l) > get<0>(r); }); else if (type == sdfi) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<0>(l) < get<0>(r); }); else if (type == sdfd) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<0>(l) > get<0>(r); });};
template<class U> void sort(vector<U> &a, tcomparator type) {    if (type == 0) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<2>(l) < get<2>(r); });    else if (type == 1) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<2>(l) > get<2>(r); });    else if (type == 2) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<2>(l) < get<2>(r); });    else if (type == 3) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<2>(l) > get<2>(r); });    else if (type == 4) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<2>(l) < get<2>(r); });    else if (type == 5) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<2>(l) > get<2>(r); });    else if (type == 6) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<2>(l) < get<2>(r); });    else if (type == 7) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<2>(l) > get<2>(r); });    else if (type == 8) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<1>(l) < get<1>(r); });    else if (type == 9) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<1>(l) > get<1>(r); });    else if (type == 10) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<1>(l) < get<1>(r); });    else if (type == 11) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<1>(l) > get<1>(r); });    else if (type == 12) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<1>(l) < get<1>(r); });    else if (type == 13) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<1>(l) > get<1>(r); });    else if (type == 14) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<1>(l) < get<1>(r); });    else if (type == 15) sort(ALL(a), [&](U l, U r) { return get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<1>(l) > get<1>(r); });    else if (type == 16) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<2>(l) < get<2>(r); });    else if (type == 17) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<2>(l) > get<2>(r); });    else if (type == 18) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<2>(l) < get<2>(r); });    else if (type == 19) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<2>(l) > get<2>(r); });    else if (type == 20) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<2>(l) < get<2>(r); });    else if (type == 21) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<2>(l) > get<2>(r); });    else if (type == 22) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<2>(l) < get<2>(r); });    else if (type == 23) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<2>(l) > get<2>(r); });    else if (type == 24) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<0>(l) < get<0>(r); });    else if (type == 25) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<0>(l) > get<0>(r); });    else if (type == 26) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<0>(l) < get<0>(r); });    else if (type == 27) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<0>(l) > get<0>(r); });    else if (type == 28) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<0>(l) < get<0>(r); });    else if (type == 29) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<0>(l) > get<0>(r); });    else if (type == 30) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<0>(l) < get<0>(r); });    else if (type == 31) sort(ALL(a), [&](U l, U r) { return get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<0>(l) > get<0>(r); });    else if (type == 32) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<1>(l) < get<1>(r); });    else if (type == 33) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<1>(l) > get<1>(r); });    else if (type == 34) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<1>(l) < get<1>(r); });    else if (type == 35) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<1>(l) > get<1>(r); });    else if (type == 36) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<1>(l) < get<1>(r); });    else if (type == 37) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<0>(l) != get<0>(r) ? get<0>(l) < get<0>(r) : get<1>(l) > get<1>(r); });    else if (type == 38) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<1>(l) < get<1>(r); });    else if (type == 39) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<0>(l) != get<0>(r) ? get<0>(l) > get<0>(r) : get<1>(l) > get<1>(r); });    else if (type == 40) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<0>(l) < get<0>(r); });    else if (type == 41) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<0>(l) > get<0>(r); });    else if (type == 42) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<0>(l) < get<0>(r); });    else if (type == 43) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) < get<2>(r) : get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<0>(l) > get<0>(r); }); else if (type == 44) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<0>(l) < get<0>(r); }); else if (type == 45) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<1>(l) != get<1>(r) ? get<1>(l) < get<1>(r) : get<0>(l) > get<0>(r); }); else if (type == 46) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<0>(l) < get<0>(r); }); else if (type == 47) sort(ALL(a), [&](U l, U r) { return get<2>(l) != get<2>(r) ? get<2>(l) > get<2>(r) : get<1>(l) != get<1>(r) ? get<1>(l) > get<1>(r) : get<0>(l) > get<0>(r); });}
/*@formatter:off*/
/*@formatter:off*/
...
template<class A, class B, class C, class F> void sortt(vector<A> &a, vector<B> &b, vector<C> &c, F f) {    auto d = vtot(a, b, c);    sort(d, f);    tie(a, b, c) = ttov(d);}
template<class A, class B, class C, class F> void rsortt(vector<A> &a, vector<B> &b, vector<C> &c, F f) {    auto d = vtot(a, b, c);    rsort(d, f);    tie(a, b, c) = ttov(d);}
template<class A, class B, class C, class D> void sortf(vector<A> &a, vector<B> &b, vector<C> &c, vector<D> &d) {    auto e = vtot(a, b, c, d);    sort(e);    tie(a, b, c, d) = ttov(e);}
template<class A, class B, class C, class D> void rsortf(vector<A> &a, vector<B> &b, vector<C> &c, vector<D> &d) {auto e = vtot(a, b, c, d);rsort(e);tie(a, b, c, d) = ttov(e);}
/*@formatter:off*/
...
template<class A, class B, class C> vi sortti(vector<A> &a, vector<B> &b, vector<C> &c, pcomparator f) {    vi ind = iota(0, sz(a));    auto d = vtot(a, b, c, ind);    sort(d, f);    rep(i, sz(a))ind[i] = d[i].d;    return ind;}
...
// ss << rhs で型によらず追加できる
// ss + rhs が上を返す
struct s_stream : public basic_string<char, char_traits<char>, allocator<char>> {
    using STR = basic_string<char, char_traits<char>, allocator<char>>;
    s_stream() : STR() {}
    template<class T>
    s_stream(const T &v) : STR() {operator<<(v);}
    template<class T>s_stream &operator<<(const T &rhs) {        stringstream ss;        ss << rhs;        (*this) += ss.str();        return *this;    }
    template<class T>    s_stream operator+(const T &rhs) {        auto res = *this;        res << rhs;        return res;    }
...
void solve() {
    ...
    int res =
            ...
            fix([&](auto f, int i, int K) -> int {
                ...
                if (S[i]) {
                    //i+1以降
                    res += comi(N - (i + 1), K) * pow(9, K);
                    deb(i, res);
                    //i番目を余裕で選ぶ
                    res += (S[i] - 1) * comi(N - (i + 1), K - 1) * pow(9, K - 1);
                    deb(i, res);
                } 
                //i番目をぎりぎり選ぶ
                res += f(i + 1, K - (!!S[i]));
