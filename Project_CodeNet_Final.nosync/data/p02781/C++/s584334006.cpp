...
int main() {
	...
	if (k == 1) {
		...
		for (int i = 0; i < n.size(); i++) {
			if (i == 0) {
				long long int a = (n[i] - '0')-1;
				sum = sum +  a * 9 * COM(n.size() - 1,1);
			}
			else {
				sum = sum + 9 * 9 * COM(n.size() - 1 - i, 1);
			}
		}
	}
		...
		for (int i = 0; i < sub.size(); i++) {
			if (i == 0) {
				long long int a = (sub[i] - '0') - 1;
				sum = sum + a * 9 * COM(sub.size() - 1, 1);
			}
			else {
				sum = sum + 9 * 9 * COM(sub.size() - 1 - i, 1);
			}
		}
		...
		for (int i = 0; i < n.size(); i++) {
			if (i == 0) {
				long long int a = (n[i] - '0') - 1;
				sum = sum + a * 9 * 9 * COM(n.size() - 1, 2);
			}
			else {
				sum = sum + 9 * 9 * 9 * COM(n.size() - 1 - i, 2);
			}
		}
	}
	cout << sum;
