...
ll k;
ll dp[101][4];
ll dpa[101][4][2];//0:madakoetyadame
ll ans;
int main(){
  cin>>n>>k;
  dp[1][1]=9;
  ...
  for(ll i=1;i<n.size();i++){
    ...
    if(ima==0){
      ...
      dpa[i][2][0]+=dpa[i-1][2][0];
      dpa[i][3][0]+=dpa[i-1][3][0];
    }else{
      //ima
      dpa[i][2][0]+=dpa[i-1][1][0];
      dpa[i][3][0]+=dpa[i-1][2][0];
      //not ima
      //0 igai
      dpa[i][2][1]+=dpa[i-1][1][0]*(ima-1);
      //0
      dpa[i][1][1]+=dpa[i-1][1][0];
      //0 igai
      dpa[i][3][1]+=dpa[i-1][2][0]*(ima-1);
      //0
      dpa[i][2][1]+=dpa[i-1][2][0];
      dpa[i][3][0]+=dpa[i-1][3][0];
    }
    //0 igai
    dpa[i][2][1]+=dpa[i-1][1][1]*9;
    dpa[i][3][1]+=dpa[i-1][2][1]*9;
    //0
    dpa[i][1][1]+=dpa[i-1][1][1];
    dpa[i][2][1]+=dpa[i-1][2][1];
    dpa[i][3][1]+=dpa[i-1][3][1];
    
  }
  cout<<ans+dpa[n.size()-1][k][0]+dpa[n.size()-1][k][1]<<endl;
}
